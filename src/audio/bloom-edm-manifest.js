...
export const BLOOM_EDM_BANKS = {
  bloom_closer_lead: {
    ...
    file: "bloom_shot_026_hyper_saw.flac",
    rootMidi: 60,
  ...
  bloom_roses_lead: {
    ...
    category: "EDM Melodic (Bloom)",
    file: "bloom_shot_025_pop_saw.flac",
    rootMidi: 60,
  ...
  bloom_inside_out_lead: {
    ...
    category: "EDM Melodic (Bloom)",
    file: "bloom_shot_032_vocal_lead.flac",
    rootMidi: 60,
  ...
  bloom_let_you_go_lead: {
    ...
    category: "EDM Melodic (Bloom)",
    file: "bloom_shot_002_soaring_lead.flac",
    rootMidi: 72,
    subCategory: "Lead",
  },
  bloom_wise_lead: {
    ...
    category: "EDM Melodic (Bloom)",
    file: "bloom_shot_024_drop_saw.flac",
    rootMidi: 60,
    subCategory: "Lead & Saw",
  },
  bloom_paris_pad: {
    ...
    category: "EDM Melodic (Bloom)",
    file: "bloom_shot_022_flume_chord.flac",
    rootMidi: 60,
  ...
  bloom_knowledge_pad: {
    ...
    category: "EDM Melodic (Bloom)",
    file: "bloom_shot_023_chord_swell.flac",
    rootMidi: 60,
    subCategory: "Future Bass / Chords",
  },
  bloom_outside_in_pad: {
    ...
    category: "EDM Melodic (Bloom)",
    file: "bloom_shot_016_vocal_stab.flac",
    rootMidi: 72,
    subCategory: "Vocal Synth",
  },
  bloom_all_we_know_pluck: {
    ...
    category: "EDM Melodic (Bloom)",
    file: "bloom_shot_012_glassy_pluck.flac",
    rootMidi: 72,
    subCategory: "Pluck",
  },
  bloom_breakdown_bass: {
    ...
    category: "EDM Melodic (Bloom)",
    file: "bloom_shot_033_gritty_reese.flac",
    rootMidi: 48,
  ...
  bloom_crushed_sub: {
    ...
    category: "EDM Melodic (Bloom)",
    file: "bloom_shot_015_punch_bass.flac",
    rootMidi: 48,
    subCategory: "Bass & Sub",
  },
  bloom_so_far_pad: {
    ...
    category: "EDM Melodic (Bloom)",
    file: "bloom_shot_017_fm_pluck_bass.flac",
    rootMidi: 48,
    subCategory: "Bass & Sub",
  },
};
